...
mod test_todo_controllers{
    ...
    use auth_service::domain::constants::POSTGRESQL_DB_URI;
    use auth_service::infrastructure::databases::postgresql::db_pool;
    use diesel_migrations::{embed_migrations, EmbeddedMigrations, MigrationHarness};
    use serde_json::json;
    use auth_service::create_app::create_app;
    use auth_service::domain::models::todo::Todo;
    use auth_service::domain::repositories::repository::ResultPaging;
    ...
    async fn test() {
       ...
       // let docker = clients::Cli::default();
        ...
        let connection_string = &format!(
            "postgres://postgres:postgres@127.0.0.1:{}/postgres","asd"
        );
